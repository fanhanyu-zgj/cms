            ...
            <div class="card-body card-body-contrast">
                ...
                <strong>{{ $errors->first('title') }}</strong>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-md-9">
                            <select name="category_id" id="category_id" class=" form-control-sm form-control-xs">
                                @foreach($categories as $category)
                                    <option value="{{$category['id']}}" {{$category['id']==$content['category_id']?'checked':''}}>{{$category['name']}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-md-9">
                            <div class="form-check form-check-inline">
                                ...
                                <input class="form-check-input" type="radio"
                                       {{old('istop',$content['istop'])=='0'?'checked':''}}
                                       name="istop" value="0"
                                       id="istop-2">
